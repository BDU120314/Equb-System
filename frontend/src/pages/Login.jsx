  ...
  return (
    <div>
      <section class="h-screen">
        <div class="h-full bg-gray-100 px-5">
          <div class="gap-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              <form className="bg-slate-300">
                <div class="relative flex items-center text-black mb-6" data-te-input-wrapper-init>
                  <input
                    type="text"
                    class="peer block min-h-[auto] text-black w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
