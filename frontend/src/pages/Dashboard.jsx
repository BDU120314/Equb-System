...
const [formData, setFormData] = useState(initialState)
  ...
  return (
    <div>
            ...
            <div className="flex items-center rounded-[5px]">
              ...
              >
                <input
                  ...
                  type="text"
                  className="bg-gray-100 w-[250px] outline-none border-2 border-gray-300 pl-3 lg:w-[350px] h-10 rounded-[5px] placeholder:text-[13px] leading-4 font-normal"
            ...
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                <div>
                  <button
                    type="button"
                    className="flex text-sm bg-gray-800 rounded-full dark:bg-white focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                    aria-expanded="false"
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-[18%] h-screen pt-20 transition-transform -translate-x-full  text-black bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-100 dark:border-gray-200"
        aria-label="Sidebar"
      >
      ...
      <div className="p-2 sm:ml-[18%]">
        <div className="border-gray-200 border-solid rounded-md dark:border-gray-300 mt-14">
